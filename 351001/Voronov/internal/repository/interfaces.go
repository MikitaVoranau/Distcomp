...
type ReactionRepository interface {
	...
	FindAll(ctx context.Context, opts *QueryOptions) ([]*model.Reaction, int64, error)
	Create(ctx context.Context, reaction *model.Reaction) (*model.Reaction, error)
	Update(ctx context.Context, id int64, reaction *model.Reaction) (*model.Reaction, error)
	Delete(ctx context.Context, id int64) error
